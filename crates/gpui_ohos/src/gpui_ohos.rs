...
pub use ohos::{
    ...
    pointer_up, root_dir, run_with_surface, scroll, set_host_ops, set_root_dir, surface_created,
    surface_destroyed, surface_resized, tick, ime_commit_text, ime_delete_backward, ime_delete_forward,
