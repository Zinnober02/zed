...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    vec![
        Menu {
            ...
            disabled: false,
            items: vec![
                MenuItem::action("About Inkstone", zed_actions::About),
                ...
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Inkstone", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Inkstone", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    "Report a Bug...",
                    super::OpenBrowser {
                        url: "https://github.com/Zinnober02/zed/issues".into(),
                    },
                ),
                MenuItem::separator(),
                MenuItem::action(
                ...
                MenuItem::action(
                    "Inkstone Repository",
                    super::OpenBrowser {
                        url: "https://github.com/Zinnober02/zed".into(),
                    },
                ),
            ],
        },
